...
<!--Descrizione dell'untente-->
  ...
  <main class="bg-gradient-to-r from-purple-200 via-orange-200 to-red-200">
    ...
    <div class=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-items-center gap-y-10">

      <div class="border-4 box-border h-96 w-96  flex justify-items-center">
        <div id="pictures" class=" snap-x flex snap-mandatory  overflow-scroll  h-92 w-92  ">
          <div id="img1" class="snap-center w-full h-full flex-shrink-0 ">
            <img src="https://blog.giallozafferano.it/dulcisinforno/wp-content/uploads/2021/03/Carbonara-ricetta-5328.jpg" alt="logo" class="w-full h-full object-cover">
          </div>
          <div id="img2" class=" snap-center w-full h-full flex-shrink-0 ">
            <img src="https://blog.giallozafferano.it/dulcisinforno/wp-content/uploads/2021/03/Carbonara-ricetta-5328.jpg" alt="logo" class="w-full h-full  object-cover">
          </div>
          <div id="img3" class="snap-center w-full h-full flex-shrink-0 ">
            <img src="https://blog.giallozafferano.it/dulcisinforno/wp-content/uploads/2021/03/Carbonara-ricetta-5328.jpg" alt="logo" class="w-full h-full object-cover">
          </div>
        </div>
      </div>
